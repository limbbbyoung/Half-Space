...
<head>
<meta charset="UTF-8">
<title>Half Space Login Page</title>
</head>
<body>
<!-- header start -->
	<div class="header">
				...
				<div class="col">
		            <div class="p-3" style="width: 400px;">
		               <form action="/login" method="post">
							<div class="form-group input-wrap mb-2">
	...
	<footer class="footer">
		<div class="footer-container">
			<a class="my-3" href="/mainBoard/welcomeHome">
				...
				<div class="d-flex flex-column justify-content-between h-100">
					<section>
						<div class="sidebar-body">
							...
							<br>
							<div class="menu-wrap">
								<a href="#"><img src="../resources/images/faq.svg" style="width: 20px; height: 20px;" class="mCS_img_loaded">FAQ</a>
							</div>
						</div>
					</section>
				</div>
