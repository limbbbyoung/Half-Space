...
<body>
	${board }
	<div class="container">	
	 <form action="/mainBoard/update" method="post">
	     ...
	     카테고리 : <input class="form-control" type="text" name= "catego" value="${board.catego}" required><br/>
	     경기 장소 : <input class="form-control" type="text" name= "gamespace" value="${board.gameplace}" required><br/>
	     경기 날짜 : <input class="form-control" type="date" name= "gamedate" value="${board.gamedate}" required><br/>
